...
class ReceivedCollectionList :  Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater!!.inflate(R.layout.cashreceived_list, container, false)
    }
    ...
    class MyQuoteAdapter : RecyclerView.Adapter<MyQuoteAdapter.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.received_collection_list, parent, false)
